  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <>
        ...
        {/* Display Section - row-wise cards */}
        <div className="my-10 px-4 max-w-7xl mx-auto flex flex-wrap justify-center gap-6 flex-col md:flex-row">
          {[1, 2, 3, 4, 5, 6].map((item, index) => (
            <div
              key={index}
              className="relative bg-white w-[300px] rounded-xl shadow-md p-4 border border-gray-200 hover:shadow-lg transition duration-200"
            >
              {/* 3 Dots Menu */}
              ...
              <p className="text-gray-700 mb-2">
                Definition: A greeting or expression of goodwill. A greeting or expression of goodwill.
