      ...
      <div className="flex justify-center mt-6 px-4">
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#49243E] focus:border-[#49243E] hover:border-gray-400 transition-all duration-200"
          />
        </div>
      </div>
    </div>
