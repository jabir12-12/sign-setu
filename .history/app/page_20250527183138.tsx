...
export default function StockDashboard() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      {/* Add Words */}
      <Dialog open={isopen} onClick={() => {
        () => setIsOpen(false)  // This is the problematic line
      ...
      <Dialog open={isdeleteOpen} onClick={() => {
        () => setDeleteOpen(false)  // This is the problematic line
      }} maxWidth="xs" fullWidth>
        <DialogTitle
          sx={{
            display: 'flex',
