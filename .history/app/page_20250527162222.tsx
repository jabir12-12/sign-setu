...
export default function StockDashboard() {
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      {/* Centered Search Bar */}
      <div className="flex justify-center mt-6 px-4 shadow-md">
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#BB8493] focus:border-[#BB8493] hover:border-gray-400 transition-all duration-200"
          />
        </div>
      </div>
    </div>
