...
export const PUT = async (req: Request, value: { params: { wordid: string } }) => {
...
export const GET = async (req: Request, value: { params: { wordid: string } }) => {
    const wordId = value.params.wordid;
    const id = { _id: wordId };
    await mongoose.connect(connectionString);
...
export const DELETE = async (req: Request, value: { params: { wordid: string } }) => {
    const wordId = value.params.wordid;
    const id = { _id: wordId };
    await mongoose.connect(connectionString);
