...
export default function StockDashboard() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      {/* Centered Search Bar */}
      <div className="flex flex-col items-center justify-center gap-6 px-4 md:px-6 py-10 mt-6">
        {/* Heading */}
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-[#49243E]">
            Visual Sign Language Dictionary
          </h2>
          <p className="text-lg md:text-xl text-[#704264] mt-3">
        ...
        <div className="flex justify-center w-full max-w-2xl">
          <div className="relative w-full shadow-lg">
            <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
              <Search className="w-6 h-6" /> {/* Larger icon */}
            </span>
            <input
              type="text"
