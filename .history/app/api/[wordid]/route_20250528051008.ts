...
export async function GET(req: NextRequest, { params }: { params: { wordid: string } }) {
...
export async function PUT(req: NextRequest, { params }: { params: { wordid: string } }) {
    const wordId = params.wordid;
...
export async function DELETE(req: NextRequest, { params }: { params: { wordid: string } }) {
    const wordId = params.wordid;
    await mongoose.connect(connectionString);
